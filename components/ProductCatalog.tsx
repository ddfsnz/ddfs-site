...
export function ProductCatalog({
    ...
    return (
        <div className="grid grid-cols-1 rounded-lg bg-white md:grid-cols-[240px_auto]">
            ...
            <div>
                <div className="flex items-center justify-between rounded-tr-lg border-b bg-gray-50 p-1 md:pl-3">
